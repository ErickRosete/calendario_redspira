...
const darkPink = ['#d10022', '#c0002f', '#ae003c', '#9d0049', '#950046']; // 201 - 300
const darkRed = ['#91003f', '#8c0038', '#870031', '#83002a', '#7e0023']; // 301 - 500
...
const colorElement = (el, AQI = 0) => {
    if (AQI <= 50) {
        ...
        el.style.backgroundColor = darkPink[colInd];
    } else {
        const colInd = Math.round(mapValue(AQI, 301, 500, 0, 4));
        el.style.backgroundColor = darkRed[colInd];
    }
    return el;
}